 ...
 * Use the [AllLandInspectorsFragment.newInstance] factory method to
...
class AllLandInspectorsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AllLandInspectorsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AllLandInspectorsFragment().apply {
