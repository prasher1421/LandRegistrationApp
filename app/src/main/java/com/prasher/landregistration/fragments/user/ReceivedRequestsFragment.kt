 ...
 * Use the [ReceivedRequestsFragment.newInstance] factory method to
...
class ReceivedRequestsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ReceivedRequestsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ReceivedRequestsFragment().apply {
